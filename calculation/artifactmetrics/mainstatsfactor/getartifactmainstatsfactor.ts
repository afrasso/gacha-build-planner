...
const getArtifactMainStatsFactor = ({
  ...
  // Unlike with set bonuses where we had to take into account the likelihood of mainmain stats into account, here we
  // don't need to because when farming from a domain, the likelihood of getting a particular set on an artifact is the
  // same regardless of the artifact type (50%).
